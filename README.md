...
Лучше всего, если до изучения этого у вас есть базовые познания в линейной алгебре, возможно в математическом анализе и в статистике/теории вероятности. Нужно понимать основы работы с FastAPI, PostgreSQL, т.к.
# Outline:
## Модели
## База
	Loss functions (1)
