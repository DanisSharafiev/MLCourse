...
Лучше всего, если до изучения этого у вас есть базовые познания в линейной алгебре, возможно в математическом анализе и в статистике/теории вероятности. Нужно понимать основы работы с FastAPI, PostgreSQL, так как основной упор я буду делать на них.
# Outline:
## Модели
## База
	Loss functions (1)
