...
Сейчас буду говорить об ошибках со стороны программы (ну ML в нашем случае). Нужно дать интуитивно понятный способ их исправить. После этого стоит сразу показать, что получилось после коррекции. Возможно, стоит сохранять подобные коррекции, чтобы в следующий раз минимизировать количество правок (фидбек). Режим коррекции не стоит убирать сразу, вдруг пользователь не доволен результатом. 
