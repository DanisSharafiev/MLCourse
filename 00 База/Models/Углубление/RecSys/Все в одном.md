...
Индексы:
IndexIVF
Работает на принципе кластеризации данных. K-means создает центроиды, входной эмбеддинг сравнивается со всеми центроидами. nprobe обозначает количество рассматриваемых кластеров, потом 
